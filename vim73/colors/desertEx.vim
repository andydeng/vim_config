...
" hacked by ripwu from 2011-10-16
" :highlight " check current colorscheme
hi Todo         term=standout        ctermbg=yellow  ctermfg=black
hi vimString    ctermfg=darkred
hi cString      ctermfg=darkred      guifg=lightred
hi cNumber      ctermfg=darkred      gui=bold         guifg=magenta
hi Error        cterm=bold           ctermfg=7        ctermbg=1

" Highlight All Function
syn match cFunction "/<[a-zA-Z_][a-zA-Z_0-9]*/>[^()]*)("me=e-2
syn match cFunction "/<[a-zA-Z_][a-zA-Z_0-9]*/>/s*("me=e-1
hi cFunction guifg=#B5A1FF

highlight RipGroup guibg=yellow
match RipGroup /TODO/
match RipGroup /NOTE/
